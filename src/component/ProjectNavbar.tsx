...
export default function NavBar(props: { project: string }) {
  ...
  return (
    <nav className='ltc-color-bg-alt ltc-color-border z-9 sticky top-[50px] text-nowrap border-b-2'>
      <div className='ltc-text-h5 mx-auto flex max-w-screen-xl items-center justify-between p-10 py-0'>
        ...
        <div className='flex shrink flex-row space-x-4'>
          <IconWithLabel text='Demo' link={project?.demo}>
            <LuExternalLink fontSize='20' />
          </IconWithLabel>
          <IconWithLabel link={project?.source} text='Source' newTab>
            <FaGithub fontSize='20' />
          </IconWithLabel>
          <IconWithLabel link={project?.blog} text='About'>
